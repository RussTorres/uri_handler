...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("myscheme://mynetloc/path/to?"
         "myqparam=null&myotherqparam=null#myfragment",
         ("thing",),
         "myscheme://mynetloc/path/to/thing?"
         "myqparam=null&myotherqparam=null#myfragment")
    ])
...
@pytest.mark.parametrize(
    "uri,expected_prefix", [
        ...
        ("myscheme://mynetloc/path/to/path/?"
         "myqparam=null&myotherqparam=null#myfragment",
         "myscheme://mynetloc/path/to?"
         "myqparam=null&myotherqparam=null#myfragment"),
        # uri at top level
        ("myscheme://mynetloc/mything?"
         "myqparam=null&myotherqparam=null#myfragment",
